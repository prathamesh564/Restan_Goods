...
export default function Blog(){
    ...
    <div className='flex md:flex-row md:justify-center md:items-center  md:text-lg md:p-10 md:mx-20'>
       ...
       <div className=" h-[250px] md:w-[560px] relative flex flex-row px-2 mx-[50px] mt-[-40px]    bg-white  ">
                      <div className=" h-[90px] hidden md:block md:w-[90px] relative flex md:flex-row md:px-2 md:ml-[400px] mx-[50px] md:mt-[-50px] bg-[#d2a679]  ">
         ...
         <div className="flex flex-col  absolute left-0 top-0 p-5 ">
             <div className='md:text-lg text-gray-600  mt-2 mx-2'>By Md SohagBurger * Food</div>
        
            <div className='md:text-3xl text-black font-marcallus font-semibold p-2  '>This prefabricated passive house is highly sustainable</div>
            <div className='md:text-2xl text-amber-700  mt-2 p-1'>READ MORE </div>
      </div>
        </div>
        </div>

            <div className="hidden md:block flex flex-col mx-10">
