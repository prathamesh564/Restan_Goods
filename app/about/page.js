...
const router=useRouter();
  ...
  />
      ...
      <div className="flex flex-col items-left items-center ">
        ...
        <div className="text-white md:text-5xl text-3xl md:mt-1 mt-50 md:ml-0 ml-15 font-serif font-sans">Restaurant Chef</div>
        
        <div className="text-white md:text-2xl text-sm p-5 md:p-[50]  md:ml-0 ml-15 items-center font-serif font-sans"> 🏡 Home &#62; About-US</div>
        </div>
...
<div className="flex md:flex-row md-[10] h-[60%] w-full justify-around items-start mr-[10px]">
      ...
      <div className="text-amber-800 md:text-2xl font-serif font-bold md:mx-[90px] md:p-5 p-10 md:items-center items-left"> ------- OUR GLOBAL BRAND PARTNER -------
        </div>
     </div>
    ...
    <div className="flex md:flex-row flex-col ">
       <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fblog%2F6-full.jpg&w=3840&q=75" className='md:h-[400px] h-[300px] md:w-[500px]   '/> 
      
     <img src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fblog%2F1-full.jpg&w=3840&q=75" className='md:h-[400px] h-[300px] md:w-[500px] md:mt-1 mt-5  '/> 
 <div className=" absolute bottom-[-100px] md:h-[450px] md:w-[700px] md:mx-[-50px] mx-[-10px] relative flex flex-col md:px-2   bg-white  ">
      
  <div className="flex flex-col">
    <div className="font-bold font-serif md:text-2xl text-2xl text-amber-800 p-5">  About US --- &#62;</div>
        <div className=" md:text-4xl text-2xl font-serif font-bold text-gray-500  mx-10">
We Invite You<br></br>
To Visit Our Restaurant</div>
        <div className=" text-1xl text-gray-500 p-4 md:mx-10 mx-1">A relaxing and pleasant atmosphere, good jazz, dinner, and cocktails. The<br></br> Patio Time Bar opens in the center of Florence. The only bar inspired by the 1960s, it will give you a experience that you’ll have a hard time forgetting.

</div>
        <div className='flex flex-row md:p-3 p-1'>
           <img
                    src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Ficon%2F6.png&w=128&q=75"
                    className="w-[50px] h-[50px] md:mx-[50px]  rounded-[75%] bg-yellow-600   p-3 "
                  />
                  <div className="">
    ...
    <div className="md:p-10 p-10"></div>
     

     <Chef/>
     
   <div className="md:p-20 p-10"></div>
       <Hour/>
